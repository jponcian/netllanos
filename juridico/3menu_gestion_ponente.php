...
<head>
	...
	<title>Expedientes por Gestionar</title>
			...
			<tbody>
				<tr>
					<td height="45" align="center" bgcolor="#FF0000">
						<p class="Estilo7"><u>Expedientes por Gestionar</u></p>
					</td>
					...
					<td height="27" align="center" bgcolor="#CCCCCC">
						<p class="Estilo7"><span class="Estilo1">
								<select name="OSEDE" size="1" onChange="this.form.submit()">
									...
									{
										$consulta_x = "SELECT expedientes_juridico.sector as sector, z_sectores.nombre as dependencia FROM expedientes_juridico, z_sectores WHERE z_sectores.id_sector = expedientes_juridico.sector and expedientes_juridico.status=1 GROUP BY expedientes_juridico.sector;";
									} else {
										// -------------------------------------
										$consulta_x = "SELECT expedientes_juridico.sector as sector, z_sectores.nombre as dependencia FROM expedientes_juridico, z_sectores WHERE z_sectores.id_sector = expedientes_juridico.sector AND expedientes_juridico.cedula_ponente = " . $_SESSION['CEDULA_USUARIO'] . " AND expedientes_juridico.sector = " . $_SESSION['SEDE_USUARIO'] . " AND expedientes_juridico.status=1 GROUP BY expedientes_juridico.sector;";
									}
									// -------------------------------------
			...
			<tbody>
				...
				if ($_POST['OSEDE'] > 0) {
					...
					while ($registro = mysql_fetch_object($tabla)) {
						...
						echo '</div></td><td ><div align="center" class="Estilo5"><div align="center"><a href="3.1gestion_ponente.php?rif=' . $registro->rif;
						echo '&num=';
						echo $registro->numero;
						echo '&anno=';
						echo $registro->anno;
