...
<body style="background: transparent !important;">
	...
	<form name="form69" method="post" action="">
		...
		<table width="38%" border="1" align="center">
			...
			<tr>
				...
				<td width="32%" align="center"><label>
						<input onclick='javascript:scwShow(this,event);' type="text" name="OINICIO" id="OINICIO" size="8" readonly value="<?php echo $_POST['OINICIO']; ?>" />
					</label></td>
				<td width="16%" bgcolor="#CCCCCC"><strong> Hasta:</strong></td>
				<td width="28%" align="center"><label>
						<input onclick='javascript:scwShow(this,event);' type="text" name="OFIN" id="OFIN" size="8" readonly value="<?php echo $_POST['OFIN']; ?>" />
					</label></td>
			</tr>
		</table>
		<p align="center">
