...
if ($registro_xx->id_sancion>60000)
	{	$titulo = 'AJUSTE MONEDA';	$siglas = 'Moneda';	}
else
	{	$titulo = 'AJUSTE UNIDAD TRIBUTARIA';	$siglas = 'UT';	}
//$pdf->Ln();
