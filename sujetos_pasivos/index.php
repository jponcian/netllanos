...
//---------------
$_SESSION['VALOR_UT_PRIMITIVA'] = -1;
?>

<html>

<head>
  <title>SUJETOS PASIVOS</title>
  <meta charset="UTF-8">
  ...
  <div class="container d-flex justify-content-center align-items-center" style="min-height:100vh;">
    <div class="card shadow p-4" style="max-width: 400px; width: 100%; position: relative;">
      ...
      <form action="valida.php" method="post">
        ...
        <div class="mb-3">
          <input type="text" class="form-control" placeholder="Ingrese Su Cédula Aqui" name="OUSUARIO" required autofocus>
        </div>
        <div class="mb-3">
