...
include "../../funciones/auxiliar_php.php";
	...
	$Titulos = array('','AUXILIAR CONTABLE TRIBUTOS INTERNOS','IMPUESTO SOBRE LA RENTA','PLANILLAS PAGADAS ','LOS LLANOS');
...
<table width="100%" border="0">
   	<tr>
		...
		<tr>
	    <td><div align="center"><strong><?php echo $tributo; ?></strong></div></td>
	</tr>	
		<tr>
 ...
 <?php
	...
	//COLUMNA 10
	$txt= voltea_fecha(dias_feriados($registro_x->fecha_not,25)); //+ 25 DIAS
	echo '<td><div align="center" class="Estilo5">';
	echo $txt;
	echo '</div></td>';
