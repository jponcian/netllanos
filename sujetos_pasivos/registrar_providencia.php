...
<body style="background: transparent !important;">
	...
	<form name="form1" method="post" action="">
		<div align="center">
			...
			<table width="50%" border="1" align="center">
				<tr>
					<td align="center" bgcolor="#FF0000" colspan="4"><span class="Estilo7"><u>Datos del Contribuyente o Sujeto Pasivo</u></span></td>
				</tr>
				<tr>
	...
	<div align="center">
		...
		if ($_SESSION['VARIABLE'] == 'REGISTRADA') {
			...
			if ($registro_x = mysql_fetch_object($tabla_x)) {
				...
				//------------------
				echo '<form name="form2" method="post" action="formatos/providencia.php?num1=' . $_SESSION['NUMERO'] . '&num2=' . $_SESSION['NUMERO'] . '&anno=' . $_SESSION['ANNO'] . '&sector=' . $_SESSION['SEDE_USUARIO'] . '" target="_blank">';
