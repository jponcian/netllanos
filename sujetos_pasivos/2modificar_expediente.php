...
if ($_POST['CMDGUARDAR'] == "Guardar") {
	...
	if ($_POST['ORIF'] <> "" and $_POST['OCOORDINADOR'] > 0 and $_POST['OFUNCIONARIO'] > 0 and $_POST['OTRIBUTO'] > 0 and $_POST['OTEXTO1'] <> '') {
		...
		if ($guardar == 1) {
			...
			$consulta = "UPDATE expedientes_especiales SET rif='" . $_POST['ORIF'] . "', Coordinador=" . $_POST['OCOORDINADOR'] . ", Funcionario=" . $_POST['OFUNCIONARIO'] . ", Usuario=" . $_SESSION['CEDULA_USUARIO'] . ", tributo=" . $_POST['OTRIBUTO'] . ", texto1='" . $_POST['OTEXTO1'] . "', Status=0 WHERE Numero=" . $_POST['ONUMERO'] . " and Anno=" . $_POST['OANNO'] . " AND Sector=" . $_POST['OSEDE'] . ";";
...
if ($_POST['ONUMERO'] > 0 and $_POST['ONUMERO_ANTERIOR'] <> $_POST['ONUMERO']) {
	$consulta_x = 'SELECT numero, anno, rif, coordinador, funcionario, FechaRegistro, Especial, tributo, texto1 FROM vista_exp_especiales WHERE sector=0' . $_POST['OSEDE'] . ' AND anno=' . $_POST['OANNO'] . ' AND numero=' . $_POST['ONUMERO'] . ';';
	...
	<form name="form1" method="post" action="">
		<div align="center">
			<table width="55%" border="1" align="center">
				<tr>
					<td height="35" colspan="9" align="center" bgcolor="#FF0000"><span class="Estilo7"><u>Datos del Expediente - Sujeto Pasivo Especial</u></span></td>
				</tr>
						...
						<span class="Estilo1">
							<select name="OSEDE" size="1" onChange="this.form.submit()">
								...
								if ($_SESSION['ADMINISTRADOR'] > 0) {
									$consulta_x = 'SELECT Sector, nombre FROM vista_exp_especiales GROUP BY sector;';
									$tabla_x = mysql_query($consulta_x);
									...
									$consulta_x = 'SELECT Sector, nombre FROM vista_exp_especiales WHERE sector=' . $_SESSION['SEDE_USUARIO'] . ' GROUP BY sector;';
									$tabla_x = mysql_query($consulta_x);
				...
				<td width="98"><label>
						<div align="center"><span class="Estilo1">
								<select name="OANNO" size="1" onChange="this.form.submit()">
									...
									<?php
									if ($_POST['OSEDE'] > 0) {
										$consulta_x = 'SELECT anno FROM vista_exp_especiales WHERE sector =0' . $_POST['OSEDE'] . ' GROUP BY anno ORDER BY anno DESC;';
										$tabla_x = mysql_query($consulta_x);
										while ($registro_x = mysql_fetch_array($tabla_x)) {
											echo '<option ';
				...
				<td width="97"><label>
						<div align="center"><span class="Estilo1">
								<select name="ONUMERO" size="1" onChange="this.form.submit()">
									...
									<?php
									if ($_POST['OANNO'] > 0) {
										$consulta_x = 'SELECT numero FROM vista_exp_especiales WHERE sector=0' . $_POST['OSEDE'] . ' AND anno=' . $_POST['OANNO'] . ' ORDER BY numero DESC;';
										$tabla_x = mysql_query($consulta_x);
										if ($registro_x = mysql_fetch_array($tabla_x)) {
											echo '<option ';
			...
			<table width="50%" border="1" align="center">
				<tr>
					<td height="33" colspan="9" align="center" bgcolor="#FF0000"><span class="Estilo7"><u>Datos del Contribuyente o Sujeto Pasivo</u></span></td>
				<tr>
			...
			<table width="50%" border="1" align="center">
				<tr>
					<td height="32" colspan="9" align="center" bgcolor="#FF0000"><span class="Estilo7"><u>Datos de los Funcionarios</u></span></td>
				</tr>
				<tr>
			...
			<table width="50%" border="1" align="center">
				...
				<tr>
					...
					<td><label>
							<select name="OTRIBUTO">
								<option value="-1">Seleccione</option>
								<?php
								$consulta2 = "SELECT id_tributo, nombre FROM a_tributos WHERE id_tributo IN (1,3) ORDER BY id_tributo;";
				...
				<tr>
					...
					<td><label>
							<input type="text" name="OTEXTO1" size="55" maxlength="255" value="<?php echo $_POST['OTEXTO1']; ?>">
						</label></td>
