...
if ($_POST['CMDGUARDAR'] == "Guardar") {
	if ($_POST['OSEDE'] > 0 and $_POST['ORIF'] <> "" and $_POST['OPLANILLA'] <> "" and $_POST['OFECHA'] <> "" and $_POST['OMONTO'] <> "" and $_POST['OFECHAI'] <> "") {
		...
		$consulta_x = 'SELECT Max(numero)+1 AS Maximo FROM ce_actadecobro WHERE sector=0' . $_POST['OSEDE'] . ' AND anno=' . date('Y') . ';'; //
		...
		$existe = 0;
		$consulta_existe = "SELECT numero, anno, sector FROM ce_actadecobro WHERE anno=" . date("Y") . " and rif='" . strtoupper($_POST['ORIF']) . "' and motivo_anulacion is null";
		...
		if ($existe < 1) {
			...
			$consulta = "INSERT INTO ce_actadecobro (numero, anno, rif, fecha_registro, id_tributo, planilla, fecha_planilla, monto_planilla, planilla_periodo_ini, planilla_periodo_fin, cedula_autorizado, inicio_sujeto_especial, usuario, sector) VALUES (" . $Maximo . ", " . date("Y") . ", '" . strtoupper($_POST['ORIF']) . "', date(now()), " . $_POST['OTRIBUTO'] . ", '" . $_POST['OPLANILLA'] . "', '" . voltea_fecha($_POST['OFECHA']) . "', '" . $_POST['OMONTO'] . "', '" . voltea_fecha($_POST['OFECHA_I']) . "', '" . voltea_fecha($_POST['OFECHA_F']) . "', " . $Gerente . ", '" . voltea_fecha($_POST['OFECHAI']) . "', " . $_SESSION['CEDULA_USUARIO'] . ", " . $_POST['OSEDE'] . ");";
			...
			echo "<script type=\"text/javascript\">alert('El contribuyente ya posee providencia emitida en el a\u00F1o actual bajo el numero => " . $existe_numero . " por => " . $dependencia . "');</script>";
		}
	} else {
...
<head>
	<title>Crear Acta de Cobro</title>
	...
	<form name="form1" method="post" action="">
		<div align="center">
			<table width="50%" border="1" align="center">
				<tr>
					<td height="35" colspan="9" align="center" bgcolor="#FF0000"><span class="Estilo7"><u>Acta de Cobro</u></span></td>
				</tr>
						...
						<span class="Estilo1">
							<select name="OSEDE" size="1" onChange="this.form.submit()">
								...
								if ($_SESSION['ADMINISTRADOR'] > 0) {
									$consulta_x = 'SELECT * FROM z_sectores WHERE id_sector<6;';
									$tabla_x = mysql_query($consulta_x);
									...
									$consulta_x = 'SELECT * FROM z_sectores where id_sector=' . $_SESSION['SEDE_USUARIO'] . ' AND id_sector<6;';
									$tabla_x = mysql_query($consulta_x);
									while ($registro_x = mysql_fetch_array($tabla_x)) {
										echo '<option ';
										if ($_POST['OSEDE'] == $registro_x['id_sector']) {
				...
				<td width="60" bgcolor="#CCCCCC" align="center"><strong>A&ntilde;o:</strong></td>
				<td width="50">
					<div align="center"><?php echo date('Y'); ?></div>
				</td>
				<td bgcolor="#CCCCCC" align="center"><strong>
						Fecha:</strong></td>
				<td>
					<div align="center"><?php echo date('d/m/Y'); ?></div>
				</td>
			</table>

			<table width="50%" border="1" align="center">
				<tr>
					<td height="34" colspan="4" align="center" bgcolor="#FF0000"><span class="Estilo7"><u>Datos del Contribuyente o Sujeto Pasivo</u></span></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3"><label><span><?php echo $registro_x->direccion;	?>
							</span></label></td>
				</tr>
			</table>
			...
			<table width="50%" border="1" align="center">
				<tr>
					<td height="33" colspan="9" align="center" bgcolor="#FF0000"><span class="Estilo7"><u>Datos de las Planillas</u></span></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="center"><input onclick='javascript:scwShow(this,event);' name="OFECHA_I" type="text" value="<?php echo $_POST['OFECHA_I']; ?>" size="15" maxlength="10" readonly>
					</td>
					<td bgcolor="#CCCCCC" align="center"><strong>Fin:</strong></td>
					<td align="center"><input onclick='javascript:scwShow(this,event);' name="OFECHA_F" type="text" value="<?php echo $_POST['OFECHA_F']; ?>" size="15" maxlength="10" readonly></td>

				</tr>
				<tr>
					<td bgcolor="#CCCCCC"><strong>Fecha Presentacion:</strong></td>
					<td colspan="4"><input onclick='javascript:scwShow(this,event);' name="OFECHA" type="text" value="<?php echo $_POST['OFECHA']; ?>" size="15" maxlength="10" readonly></td>
				</tr>
				<tr>
