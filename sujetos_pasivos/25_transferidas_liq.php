...
<body style="background: transparent !important;">
	...
	if ($_POST['CMDCARGAR'] == 'Cargar') {
		...
		$consulta = "SELECT rif FROM vista_transferidas_esp_liquidacion WHERE fecha_transferencia_a_liq BETWEEN '" . $_SESSION['INICIO'] . "' AND '" . $_SESSION['FIN'] . "' AND sector = " . $_POST['OSEDE'] . "";
