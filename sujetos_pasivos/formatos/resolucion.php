...
$pdf->SetFont('Times','B',13-$tamaño);
	...
	$pdf->SetFont('Times','B',11);
	$pdf->SetX(60);
	$pdf->MultiCell(0,5,$registro_datos->contribuyente);
	$pdf->Ln(3); 
	...
	$pdf->SetFont('Times','B',11);
	$pdf->SetX(60);
	$pdf->MultiCell(0,5,trim($registro_datos->direccion));
