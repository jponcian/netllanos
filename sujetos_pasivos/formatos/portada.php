...
$consulta = "SELECT expedientes_especiales.Numero, expedientes_especiales.Anno, expedientes_especiales.Rif, expedientes_especiales.FechaRegistro, expedientes_especiales.Coordinador, expedientes_especiales.Funcionario, expedientes_especiales.Fecha_proceso, expedientes_especiales.Usuario, expedientes_especiales.Sector, expedientes_especiales.Status, expedientes_especiales.FechaAnulacion, expedientes_especiales.MotivoAnulacion, concat(z_empleados.Nombres,' ',z_empleados.Apellidos) AS Nombre_Coordinador, concat(Empleados.Nombres,' ',Empleados.Apellidos) AS Nombre_Funcionario, vista_contribuyentes_direccion.contribuyente, vista_contribuyentes_direccion.direccion, contribuyentes.Telefonos, contribuyentes.fechaespecial FROM expedientes_especiales INNER JOIN z_empleados ON z_empleados.cedula = expedientes_especiales.Coordinador INNER JOIN z_empleados AS Empleados ON Empleados.cedula = expedientes_especiales.Funcionario INNER JOIN vista_contribuyentes_direccion ON vista_contribuyentes_direccion.rif = expedientes_especiales.Rif INNER JOIN contribuyentes ON contribuyentes.rif = vista_contribuyentes_direccion.rif WHERE expedientes_especiales.Sector=".$SEDE." and expedientes_especiales.Anno = ".$ANNO." AND expedientes_especiales.Numero = ".$NUMERO."";
