...
if ($_POST['CMDGUARDAR'] == "Guardar") {
	if ($_POST['OSEDE'] > 0 and $_POST['ORIF'] <> "" and $_POST['OPLANILLA'] <> "" and $_POST['OFECHA'] <> "" and $_POST['OMONTO'] <> "" and $_POST['OFECHAI'] <> "") {
		...
		if ($existe < 1) {
			...
			$consulta = "UPDATE ce_providencia SET fecha_prov='" . voltea_fecha($_POST['OFECHAPR']) . "', fecha_not='" . voltea_fecha($_POST['OFECHAN']) . "', fecha_iseniat='" . voltea_fecha($_POST['OFECHAS']) . "', rif='" . strtoupper($_POST['ORIF']) . "', id_tributo=" . $_POST['OTRIBUTO'] . ", planilla='" . $_POST['OPLANILLA'] . "', fecha_planilla='" . voltea_fecha($_POST['OFECHAP']) . "', monto_planilla=" . $_POST['OMONTO'] . ", planilla_periodo_ini='" . voltea_fecha($_POST['OFECHA_I']) . "', planilla_periodo_fin='" . voltea_fecha($_POST['OFECHA_F']) . "', inicio_sujeto_especial='" . voltea_fecha($_POST['OFECHAI']) . "', usuario=" . $_SESSION['CEDULA_USUARIO'] . ", sector=" . $_POST['OSEDE'] . " WHERE id_providencia=" . $_POST['OID'] . ";";
...
if ($_POST['ONUMERO'] > 0 and $_POST['ONUMERO_ANTERIOR'] <> $_POST['ONUMERO']) {
	$consulta_x = 'SELECT * FROM ce_providencia WHERE sector=0' . $_POST['OSEDE'] . ' AND anno=' . $_POST['OANNO'] . ' AND numero=' . $_POST['ONUMERO'] . ';';
	...
	$_POST['OFECHAPR'] = voltea_fecha($registro_x['fecha_prov']);
	$_POST['OFECHAN'] = voltea_fecha($registro_x['fecha_not']);
	$_POST['OFECHAS'] = voltea_fecha($registro_x['fecha_iseniat']);
		...
		<div align="center">
			...
			<table width="50%" border="1" align="center">
				...
				<tr>
					...
					<td><input onclick='javascript:scwShow(this,event);' name="OFECHAI" type="text" value="<?php echo $_POST['OFECHAI']; ?>" size="15" maxlength="10" readonly></td>
					<td bgcolor="#CCCCCC"><strong>Fecha Providencia:</strong></td>
					<td><input onclick='javascript:scwShow(this,event);' name="OFECHAPR" type="text" value="<?php echo $_POST['OFECHAPR']; ?>" size="15" maxlength="10" readonly></td>
				</tr>
				<tr>
					<td bgcolor="#CCCCCC"><strong>Fecha Notificaci&oacute;n:</strong></td>
					<td><input onclick='javascript:scwShow(this,event);' name="OFECHAN" type="text" value="<?php echo $_POST['OFECHAN']; ?>" size="15" maxlength="10" readonly></td>
					<td bgcolor="#CCCCCC"><strong>Fecha ISeniat:</strong></td>
					<td><input onclick='javascript:scwShow(this,event);' name="OFECHAS" type="text" value="<?php echo $_POST['OFECHAS']; ?>" size="15" maxlength="10" readonly></td>
				</tr>
			</table>
