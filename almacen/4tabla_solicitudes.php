...
<table class="table table-bordered table-sm align-middle text-center mt-3">
  ...
  <tbody>
    ...
    $consulta = "SELECT * FROM vista_alm_solicitud WHERE $filtro $filtro2 status=0 ORDER BY id_solicitud DESC;";
    ...
    ?>
      <tr>
        ...
        <td>
          <button type="button" class="btn btn-outline-danger btn-aprobar-modal" data-url="4aprobar_solicitud.php?solicitud=<?php echo $registro->id_solicitud; ?>">Procesar</button>
        </td>
        <td>
