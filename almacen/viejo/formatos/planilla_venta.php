...
$pdf->ln(3);
$pdf->SetFont('Times','BIU');
$pdf->Cell(22,6,'Dirección:',$linea_muestra,'L');
//---------------
...
$pdf->SetFont('Times');
$pdf->Cell(35,6,'BsS. '.number_format(doubleval($monto),2,',','.'),$linea_muestra,0,'R');
//---------------
...
$pdf->SetFont('Times');
$pdf->Cell(35,6,'BsS. '.number_format(doubleval($total),2,',','.'),$linea_muestra,0,'R');
//---------------
...
while ($registro = mysql_fetch_object($tabla))
	...
	$pdf->SetXY($x,$y);
	$d = 20;
	$pdf->MultiCell($d,6,number_format(doubleval($registro->precio),2,',','.'),$linea_muestra,'C');
	
	$x = $x + $d;
	$pdf->SetXY($x,$y);
	$e = 20;
	$pdf->MultiCell($e,6,number_format(doubleval($registro->cantidad * $registro->precio),2,',','.'),$linea_muestra,'C');
