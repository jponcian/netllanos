  ...
  <tbody>
    ...
    ?>
      <tr>
        ...
        <td>
          <button type="button" class="btn btn-outline-danger btn-anular-modal" data-url="9anular_solicitud.php?solicitud=<?php echo $registro->id_solicitud; ?>">Anular</button>
        </td>
        <td>
