  ...
  <div class="container d-flex justify-content-center align-items-center" style="min-height:100vh;">
    <div class="card shadow p-4" style="max-width: 400px; width: 100%; position: relative;">
      ...
      <form action="valida.php" method="post">
        ...
        <div class="mb-3">
          <input type="text" class="form-control" placeholder="Ingrese Su Cédula Aqui" name="OUSUARIO" required
            autofocus>
        </div>
        <div class="mb-3">
          <input type="password" class="form-control" placeholder="Ingrese Su Clave Aqui" name="OCLAVE" required>
        </div>
...
<script>
  // Al cargar este login, forzar menú vacío en el padre
  if (window.parent && window.parent !== window) {
    window.parent.postMessage({ accion: 'mostrarMenuVacio' }, '*');
  }
</script>
