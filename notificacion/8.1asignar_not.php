					...
					<div align="center">
						...
						<p>
							<select name="OFUNCIONARIO" size="1">
								...
								<?php
								//--------------------
								$consulta_x = "SELECT cedula, Nombres, Apellidos, id_origen FROM z_empleados WHERE (Rol='N' or Rol2='N') AND cedula>1000000 and sector=" . $_SESSION['SEDE_USUARIO'] . ";";
								$tabla_x = mysql_query($consulta_x);
								while ($registro_x = mysql_fetch_object($tabla_x))
								//-------------
								{
									if ($_SESSION['ORIGEN_USUARIO'] > 0) {
										if ($_SESSION['ORIGEN_USUARIO'] == $registro_x->id_origen) {
											echo '<option';
