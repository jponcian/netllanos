...
<head>
	<title>Expedientes para reasignar Notificador</title>
	<style type="text/css">
		<!--
		.Estilomenun {
			...
			<tbody>
				<tr>
					<td height="45" align="center" bgcolor="#FF0000">
						<p class="Estilo7"><u>Expedientes por Asignar Notificador </u></p>
					</td>
			...
			<tbody>
				...
				if ($_POST['OSEDE'] > 0) {
					...
					while ($registro = mysql_fetch_object($tabla)) {
						...
						echo $i;
						echo '</div></td><td ><div align="center" class="Estilo5"><div align="center"><a href="8.1asignar_not.php?rif=' . $registro->rif;
						echo '&num=';
