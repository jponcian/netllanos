...
<head>
	<title>Expedientes x Asignar Notificador</title>
	<style type="text/css">
		<!--
		.Estilomenun {
			...
			<tbody>
				...
				if ($_POST['OSEDE'] > 0) {
					...
					while ($registro = mysql_fetch_object($tabla)) {
						...
						echo $i;
						echo '</div></td><td ><div align="center" class="Estilo5"><div align="center"><a href="2.1asignar_not.php?rif=' . $registro->rif;
						echo '&num=';
