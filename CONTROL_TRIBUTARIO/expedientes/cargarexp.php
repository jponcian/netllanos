...
$registros = "SELECT * FROM ct_temp_salida_expediente WHERE Anno_memo=$año AND NroMemo=$numeromemo and sector=$sector";
//echo $registros;
...
$sql_bloquear= "SELECT * FROM ct_temp_salida_expediente WHERE Anno_Memo=".$año." and NroMemo=".$numeromemo." and sector=".$sector;
