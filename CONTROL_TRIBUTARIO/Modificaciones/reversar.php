...
<body style="background: transparent !important;">
  <div class="container">
    <h3 class="text-center">Reversar Expediente al Fiscal Actuante</h3>
    <div class="row justify-content-center border" style="width: 40%; position :relative !important; left: 31% !important; padding: 20px;">
      ...
      <form class="needs-validation" novalidate>
        <div class="form-row">
          <div class="form-row"><strong>
            ...
            <div class="col-md-12 mb-3">
              ...
              <select class="form-select" aria-label="Default select example" id="cbosectorReverso">
            ...
            <div class="col-md-12 mb-3">
              <label for="annoProvidenciaReverso">Año Providencia:</label>
              <input type="text" class="form-control" id="annoProvidenciaReverso" placeholder="Año Providencia" required>
            ...
            <div class="col-md-12 mb-3">
              <label for="numeroProvidenciaReverso">Numero Providencia:</label>
              <input type="text" class="form-control" id="numeroProvidenciaReverso" placeholder="Numero Providencia" required>
              <div class="valid-tooltip">
                Ingrese numero de la providencia administrativa
              </div>
            </div>
            <button id="buscarReversar" class="btn btn-success" type="button">Buscar</button>
          </div>
        ...
        <button id="btnReversar" class="btn btn-primary" type="button" disabled>Reversar Expediente</button>
