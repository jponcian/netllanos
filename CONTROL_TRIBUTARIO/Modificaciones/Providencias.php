...
<body style="background: transparent !important;">
  <div class="container">
    <h3 class="text-center">Modificar Datos Providencia Administrativa</h3>
      ...
      <form class="needs-validation" novalidate>
        <div class="form-row">
          <div class="form-row"><strong>
            ...
            <div class="col-md-12 mb-3">
              ...
              <select class="form-select" aria-label="Default select example" id="cbosector">
            ...
            <div class="col-md-12 mb-3">
              <label for="annoProvidencia">Año Providencia:</label>
              <input type="text" class="form-control" id="annoProvidencia" placeholder="Año Providencia" required>
            ...
            <div class="col-md-12 mb-3">
              <label for="numeroProvidencia">Numero Providencia:</label>
              <input type="text" class="form-control" id="numeroProvidencia" placeholder="Numero Providencia" required>
              <div class="valid-tooltip">
                Ingrese numero de la providencia administrativa
              </div>
            </div>
            <button id="buscarProv" class="btn btn-success" type="button">Buscar</button>
          </div>
        ...
        <div class="form-row">
          <div class="form-row"><strong>
            ...
            <div class="col-md-12 mb-3">
              <label for="fechaNotificacion">Fecha de Notificacion</label>
              <input type="text" class="form-control" id="fechaNotificacion" required>
              <div class="valid-tooltip">
                Looks good!
              </div>
            </div>
        ...
        <button id="btnGuardar" class="btn btn-primary" type="button" disabled>Guardar</button>
        <button id="btnQuitar" class="btn btn-primary" type="button" disabled>Quitar Notificacion</button>
