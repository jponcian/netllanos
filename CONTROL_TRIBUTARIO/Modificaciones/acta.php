...
<body style="background: transparent !important;">
  <div class="container">
    <h3 class="text-center">Modificar Actas Fiscales</h3>
      ...
      <form class="needs-validation" novalidate>
        <div class="form-row">
          <div class="form-row"><strong>
            ...
            <div class="col-md-12 mb-3">
              ...
              <select class="form-select" aria-label="Default select example" id="cbosectorActa">
            ...
            <div class="col-md-12 mb-3">
              <label for="annoProvidenciaActa">Año Providencia:</label>
              <input type="text" class="form-control" id="annoProvidenciaActa" placeholder="Año Providencia" required>
            ...
            <div class="col-md-12 mb-3">
              <label for="numeroProvidenciaActa">Numero Providencia:</label>
              <input type="text" class="form-control" id="numeroProvidenciaActa" placeholder="Numero Providencia" required>
              <div class="valid-tooltip">
                Ingrese numero de la providencia administrativa
              </div>
            </div>
            <button id="buscarActa" class="btn btn-success" type="button">Buscar</button>
          </div>
        ...
        <div class="form-row">
          <div class="form-row">
            ...
            <div class="col-md-12 mb-3">
              <label for="procedimientoActa">Procedimiento</label>
              <input type="text" class="form-control" id="procedimientoActa" required>
              <small class="text-danger">Ejm: 112, 114#01, 115#03, 115#04</small>
              <div class="valid-tooltip">
                Looks good!
              </div>
            </div>
        ...
        <div class="form-row">
          <div class="form-row">
            <div class="col-md-12 mb-3">
              <label for="tipoActa">Tipo</label>
              <input type="text" class="form-control" id="tipoActa" required>
              <small class="text-danger">0: Reparo 1: Conformidad 2: Infracción</small>
              <div class="valid-tooltip">
                Looks good!
              </div>
            </div>
        ...
        <button id="btnGuardarActa" class="btn btn-primary" type="button" disabled>Guardar</button>
