...
<body style="background: transparent !important;">
  <p>
    ...
    $consulta_00 = "SELECT * FROM vista_re_exp_sucesiones WHERE anno=" . $_SESSION['ANNO_PRO'] . " AND numero=" . $_SESSION['NUM_PRO'] . " AND sector =" . $_SESSION['SEDE'] . ";";
  ...
  <form name="form1" method="post" action="#vista">
    <table width="60%" border="1" align="center">
      ...
      <tr>
        ...
        <td width="10%"><label>
            <div align="center"><span class="Estilo15"><?php echo voltea_fecha($registro_00->fecha_registro); ?></span></div>
          </label></td>
    ...
    if ($_POST['OPLANILLA'] == '' and ($_POST['OSANCION'] == '383' or $_POST['OSANCION'] == '15162' or $_POST['OSANCION'] == '15163')) {
      $consulta_x = "SELECT declaracion, fecha_declaracion, fecha_fall FROM expedientes_sucesiones WHERE rif='" . $rif . "';";
      $tabla_x = mysql_query($consulta_x);
      $registro_x = mysql_fetch_object($tabla_x);
      //-------------------
      $_POST["OINICIO"] = voltea_fecha($registro_x->fecha_fall);
      $_POST["OPLANILLA"] = $registro_x->declaracion;
      $_POST["OPRESENTACION"] = voltea_fecha($registro_x->fecha_declaracion);
    }
    //-----------------
    if ($_POST['OPLANILLA'] == '' and ($_POST['OSANCION'] == '384' or $_POST['OSANCION'] == '15168' or $_POST['OSANCION'] == '15169' or $_POST['OSANCION'] == '15226')) {
      $consulta_x = "SELECT sustitutiva, fecha_sustitutiva, fecha_fall FROM expedientes_sucesiones WHERE rif='" . $rif . "';";
      $tabla_x = mysql_query($consulta_x);
      $registro_x = mysql_fetch_object($tabla_x);
      //-------------------
      $_POST["OINICIO"] = voltea_fecha($registro_x->fecha_fall);
      $_POST["OPLANILLA"] = $registro_x->sustitutiva;
      $_POST["OPRESENTACION"] = voltea_fecha($registro_x->fecha_sustitutiva);
    }
    //-----------------
