...
$consulta3 = "SELECT id_liquidacion, anno_expediente, num_expediente, sector, origen_liquidacion FROM liquidacion WHERE rif='".$rif."' AND id_sancion=".$_POST['OSANCION']." AND periodoinicio='".voltea_fecha($_POST['OINICIO'])."' AND periodofinal='".voltea_fecha($_POST['OFIN'])."' AND estatus<>92;"; //echo $consulta3;
