...
*/
		...
		*/
		function centenas($centenas){
				...
				60=>'sesenta',70=>'setenta',80=>'ochenta',90=>'noventa',100=>'cientos',
				200=>'dos',300=>'tres',400=>'cuatro',500=>'quinientos',600=>'seis',700=>'setecientos',800=>'ocho',900=>'novecientos');
		
				switch($centenas){
						case '1': return $valores[100]; break;
						case '2': return $valores[200]; break;
						case '3': return $valores[300]; break;
						case '4': return $valores[400]; break;
						case '5': return $valores[500]; break;
						case '6': return $valores[600]; break;
						case '7': return $valores[700]; break;
						case '8': return $valores[800]; break;
						case '9': return $valores[900]; break;
