...
if ($_POST['CMDAPROBAR'] == "Devolver") {
	...
	$consulta = "UPDATE expedientes_fiscalizacion SET fecha_reverso=date(now()), status=3, usuario_reverso=" . $_SESSION['CEDULA_USUARIO'] . ", usuario=" . $_SESSION['CEDULA_USUARIO'] . " WHERE id_expediente=" . $_POST['OID'] . ";";
	$tabla = mysql_query($consulta);
	// MENSAJE
	echo "<script type=\"text/javascript\">alert('Providencia Devuelta Exitosamente!!!');</script>";
...
<head>
	<title>Regresar Providencia</title>
...
<body style="background: transparent !important;">
	...
	<form name="form1" method="post" action="#vista">
		<table width="47%" border="1" align="center">
			<tr>
				<td height="35" align="center" bgcolor="#FF0000" colspan="6"><span class="Estilo7"><u>Selecci�n de la Providencia a Reversar</u></span></td>
			</tr>
			<tr>
				<td bgcolor="#CCCCCC">
				...
				<td><label>
						<div align="center"><span class="Estilo1">
								<select name="ONUMERO" size="1" onChange="this.form.submit()">
									...
									<?php
									if ($_POST['OANNO'] > 0) {
										$consulta_x = 'SELECT numero FROM expedientes_fiscalizacion WHERE (status>=4 and status<=6) and anno=' . $_POST['OANNO'] . ' AND sector=0' . $_POST['OSEDE'] . ' GROUP BY numero ORDER BY numero DESC;';
										$tabla_x = mysql_query($consulta_x);
										while ($registro_x = mysql_fetch_array($tabla_x)) {
											echo '<option ';
		...
		?>
			<table width="50%" border="1" align="center">
				<tr>
					<td height="36" colspan="8" align="center" bgcolor="#FF0000"><span class="Estilo7"><u>Datos de la Providencia</u></span></td>
				</tr>
				<tr>
					<td bgcolor="#CCCCCC">
