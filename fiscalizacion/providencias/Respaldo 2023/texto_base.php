...
Se emite la presente Providencia en tres (3) ejemplares, de un mismo tenor y a un solo efecto, uno de los cuales queda en poder del sujeto pasivo, quien firma en señal de notificación.
	...
	case 2110:
		...
		$texto_obj = utf8_decode("verificar el cumplimiento del deber formal de llevar los libros y registros especiales establecidos en el articulo 56 de la Ley de Impuesto al Valor Agregado reformada mediante Gaceta Oficial Extraordinaria Nro. 6.152 de fecha 18-11-2014, Decreto Constituyente que establece regimen temporal de pago de anticipo del Impuesto al Valor Agregado e Impuesto Sobre la Renta para los Sujetos Pasivos Calificados como Especiales publicado en Gaceta Oficial Extraordinario N° 6.396 de fecha 21-08-2018, así como las condiciones establecidas en el Capitulo II del Reglamento General de la ley que establece el Impuesto al Valor Agregado, y en el caso de contribuyentes formales lo dispuesto en la Providencia Administrativa Nro. SNAT/2003/1.677 publicada en Gaceta Oficial Nro. 37.677 de fecha 25-04-2003, asi como el llevar la relacion de entradas y salidas de inventario establecida en el articulo 177 del Reglamento de Ley de Impuesto Sobre la Renta vigente, por parte del sujeto pasivo arriba identificado para el(los) período(s) fiscal(es): desde ").$registro->texto1;
		}
...
Se emite la presente Providencia en tres (3) ejemplares, de un mismo tenor y a un solo efecto, uno de los cuales queda en poder del sujeto pasivo, quien firma en señal de notificación.
	...
	case 2115:
		...
		$texto_obj = utf8_decode("verificar el cumplimiento del deber formal establecido en la Providencia  Administrativa SNAT/2018/0141 de fecha 16-10-2018 publicada en Gaceta Oficial Nro. 41518 de fecha 06/11/2018 que establecen las Normas Generales de Emisión de Facturas y Otros Documentos, lo referente al cumplimiento de los deberes formales establecidos en la Ley de Impuesto al Valor Agregado, su reglamento, decretos, providencias y resoluciones vigentes para el(los) periodo(s) investigado(s), Decreto Constituyente que establece regimen temporal de pago de anticipo del Impuesto al Valor Agregado e Impuesto Sobre la Renta para los Sujetos Pasivos Calificados como Especiales publicado en Gaceta Oficial Extraordinario N° 6396 de fecha 21/08/2018, así como los deberes formales establecidos en la Ley de Impuesto sobre la Renta, su reglamento, decretos, providencias y resoluciones vigentes para el(los) ejercicio(s) investigado(s), por parte del sujeto pasivo arriba identificado para el(los) período(s) fiscal(es): ").$registro->texto1;
...
Se emite la presente Providencia en tres (3) ejemplares, de un mismo tenor y a un solo efecto, uno de los cuales queda en poder del sujeto pasivo, quien firma en señal de notificación.
	...
	case 2117:
		...
		$texto_obj = utf8_decode("verificar el cumplimiento del deber formal de llevar los libros y registros especiales establecidos en el articulo 56 de la Ley de Impuesto al Valor Agregado reformada mediante Gaceta Oficial Extraordinaria Nro. 6.507 de fecha 29-01-2020, Decreto Constituyente que establece regimen temporal de pago de anticipo del Impuesto al Valor Agregado e Impuesto Sobre la Renta para los Sujetos Pasivos Calificados como Especiales publicado en Gaceta Oficial Extraordinario N° 6.396 de fecha 21-08-2018, así como las condiciones establecidas en el Capitulo II del Reglamento General de la ley que establece el Impuesto al Valor Agregado, y en el caso de contribuyentes formales lo dispuesto en la Providencia Administrativa Nro. SNAT/2003/1.677 publicada en Gaceta Oficial Nro. 37.677 de fecha 25-04-2003, por parte del sujeto pasivo arriba identificado para el(los) período(s) fiscal(es): desde ").$registro->texto1;
		}
...
Se emite la presente Providencia en tres (3) ejemplares, de un mismo tenor y a un solo efecto, uno de los cuales queda en poder del sujeto pasivo, quien firma en señal de notificación.
	...
	case 2119:
		...
		$texto_obj = utf8_decode("verificar el cumplimiento del deber formal establecidos en las Providencias Administrativas SNAT/2011/0071 de fecha 08/11/2011, Gaceta Oficial N° 39795 de fecha 08/11/2011 y SNAT/2018/0141 de fecha 16-10-2018 Gaceta Oficial 41518 de fecha 06/11/2018, que establecen las normas generales de emision de facturas y otros documentos, y las normas relativas a imprentas y maquinas fiscales lo referente a llevar los libros y registros especiales establecidos en el articulo 54,55,56 y 57 de la Ley de Impuesto al Valor Agregado Gaceta Oficial Extraordinaria 6507 de fecha 29/01/2020, y para los contribuyentes formales lo dispuesto en la Providencia Administrativa SNAT/2003/1677 Gaceta Oficial 37677 de fecha 25/04/2003, por parte del sujeto pasivo arriba identificado para el(los) período(s) fiscal(es): ").$registro->texto1;
