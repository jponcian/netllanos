		...
		<table width="38%" border="1" align="center">
			...
			<tr>
				<td colspan="2" bgcolor="#CCCCCC">
					<div align="center"><strong>A&ntilde;o de Emisi&oacute;n: </strong></div>
				</td>
				<td colspan="2" bgcolor="#CCCCCC">
			...
			<tr>
				...
				<td colspan="3"><label>
						<select name="OSUPERVISOR" size="1">
							...
							<?php
							//--------------------
							$consulta_x = "SELECT z_empleados.cedula, Apellidos, Nombres, modulo, z_accesos_roles.rol FROM z_empleados, z_empleados_roles, z_accesos_roles where z_empleados_roles.cedula = z_empleados.cedula AND z_empleados_roles.rol = z_accesos_roles.id AND z_empleados.cedula>1000000 AND z_accesos_roles.rol='Coordinador' and sector=" . $_POST['OSEDE'] . " AND modulo='FISCALIZACION';";
							echo $consulta_x;
							$tabla_x = mysql_query($consulta_x);
							while ($registro_x = mysql_fetch_object($tabla_x))
							//-------------
