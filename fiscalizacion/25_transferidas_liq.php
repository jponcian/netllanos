...
<body style="background: transparent !important;">
	...
	<form name="form1" method="post" action="">
		...
		<table width="38%" border="1" align="center">
			<tr>
				<td align="center" class="TituloTabla" colspan="9"><span><u>Transferidas a Liquidaci&oacute;n </u></span></td>
			</tr>
			<tr>
				<td align="center" class="TituloTabla" colspan="9"><span><u>Seleccionar Fechas o Periodos</u> </span></td>
			</tr>
			<tr>
	...
	if ($_POST['CMDCARGAR'] == 'Cargar') {
		$consulta = "SELECT rif FROM vista_transferidas_fis_liquidacion WHERE fecha_transferencia_a_liq BETWEEN '" . $_SESSION['INICIO'] . "' AND '" . $_SESSION['FIN'] . "' AND sector = " . $_SESSION['SEDE'] . ""; //echo $consulta;
		$tabla = mysql_query($consulta);
		$numero_filas = mysql_num_rows($tabla);

		if ($numero_filas > 0) {
	?><form name="form4" method="post" action="Reportes/transferidas_a_liquidacion.php" target="_blank">
