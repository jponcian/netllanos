...
<body style="background: transparent !important;">
	...
	<form method="post" name="Logar" action="">
		...
		<table class="formateada" width="80%" border=0 align=center>
			<tbody>
				<tr>
					<td bgcolor="#FF0000" height="39" colspan="11" align="center">
						<p class="Estilo7"><u>DIV. Fiscalizaci&oacute;n</u></p>
					</td>
				</tr>
				<tr>
					...
					<td bgcolor="#CCCCCC">
						<div align="center" class="Estilo14"><strong>Est</strong></div>
					</td>
					<td bgcolor="#CCCCCC">
					...
					<td bgcolor="#CCCCCC">
						<div align="center" class="Estilo14"><strong>Funcionario</strong></div>
					</td>
					<td bgcolor="#CCCCCC">
				...
				?>
							<tr id="fila<?php echo $i; ?>">
								...
								<td>
									<div class="Estilo8 Estilo19"><?php echo $valor['status'] ?></div>
								</td>
								<td align="center">
	...
	<table class="formateada" width="80%" border=1 align=center>
		<tbody>
			<tr>
				<td bgcolor="#FF0000" height="39" colspan="10" align="center">
			...
			<tr>
				...
				<td bgcolor="#CCCCCC" height="27">
					<div align="center" class="Estilo8"><strong>Est</strong></div>
				</td>
				<td bgcolor="#CCCCCC">
				...
				<td bgcolor="#CCCCCC">
					<div align="center" class="Estilo8"><strong>Funcionario</strong></div>
				</td>
				<td bgcolor="#CCCCCC">
					<div align="center" class="Estilo8"><strong>Sancionado</strong></div>
				</td>
