...
$titulo = "Actas Fiscales Parcialmente Aceptadas";
?>
...
vista_actas_siger.fecha_notificacion BETWEEN '" . voltea_fecha($inicio) . "' AND '" . voltea_fecha($fin) . "' AND vista_actas_siger.ajuste_voluntario > 0 AND (vista_actas_siger.ajuste_voluntario < vista_actas_siger.impuesto_omitido and vista_actas_siger.ajuste_voluntario > 0)" . $sector . " GROUP BY a_tipo_programa.id_programa";
