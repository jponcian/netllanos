...
$titulo = "Actas Fiscales Totalmente Aceptadas";
?>
...
vista_actas_siger.fecha_notificacion BETWEEN '" . voltea_fecha($inicio) . "' AND '" . voltea_fecha($fin) . "' AND vista_actas_siger.ajuste_voluntario = vista_actas_siger.impuesto_omitido" . $sector . " GROUP BY a_tipo_programa.id_programa";
