...
$titulo = "Casos en Proceso A&ntilde;os Anteriores";
?>
...
<body style="background: transparent !important;">
	...
	//RECORREMOS LAS PROVIDENCIAS NOTIFICADAS EN EL A�O y las agregamos a Casos_en_Proceso
	...
	while ($reg = $tabla->fetch_object()) {
		...
		if ($row > 0) { ?>
				...
				<table>
					...
					while ($registro = $tabla->fetch_object()) { ?>
						<tr>
							...
							<td><?php echo ($registro->emision) ?></td>
							<td><?php echo ($registro->notificacion) ?></td>
			...
			<div>
				<table width="30%">
					<tr>
						<th><?php echo "Resumen " . utf8_encode($titulo) ?></th>
						<th>Cantidad</th>
					</tr>
					<?php
					//RESUMEN EMITIDAS
