...
<body style="background: transparent !important;">
		...
		<table border="1" align="center">
			...
			<tr>
				<td height="27" align="center" bgcolor="#999999">
					<p class="Estilo2 Estilo8 Estilo7"><strong>Dependencia =&gt;</strong></p>
				</td>
				<td height="27" align="center" bgcolor="#999999">
					<p class="Estilo7"><span class="Estilo1">
							<select name="OSEDE" size="1" onChange="this.form.submit()">
								...
								if ($_SESSION['ADMINISTRADOR'] > 0) {
									...
									// -------------------------------------
									$consulta_x = 'SELECT sector, dependencia FROM vista_sanciones_aplicadas WHERE memo>0 ' . $origen . ' ' . $sede . ' GROUP BY sector;';
								}
								//---------------
				...
				<td height="27" align="center" bgcolor="#999999">
					<p class="Estilo2 Estilo8 Estilo7"><strong>Transferencia =&gt;</strong></p>
				</td>
				<td height="27" align="center" bgcolor="#999999">
					<p class="Estilo7"><span class="Estilo1">
							<select name="OMEMO" size="1" onChange="this.form.submit()">
								...
								if ($_POST['OSEDE'] > 0) {
									...
									// -------------------------------------
									$consulta_x = 'SELECT memo FROM vista_sanciones_aplicadas WHERE memo>0 AND sector=0' . $_POST['OSEDE'] . ' ' . $origen . ' GROUP BY memo ORDER BY memo DESC';
									$tabla_x = mysql_query($consulta_x);
									while ($registro_x = mysql_fetch_array($tabla_x)) {
										echo '<option ';
	...
	<p>
		...
		?>
	<form name="form3" method="post" action="reportes/transferidas_a_notificacion.php?sede=<?php echo $_POST['OSEDE'] ?>&memo=<?php echo $_POST['OMEMO'] ?>&origen=0<?php echo $origen ?>" target="_blank">
