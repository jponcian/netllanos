	...
	<form name="form1" method="post" action="">
		<table width="50%" border=1 align=center>
			<tbody>
				...
				<?php
				$consulta = "SELECT monto_bs, concurrencia, especial, serie, liquidacion FROM vista_sanciones_aplicadas WHERE status=19 AND rif='" . $_GET['rif'] . "' AND anno_expediente=" . $_GET['anno'] . " AND num_expediente=" . $_GET['num'] . " AND sector=" . $_GET['sector'] . " ORDER BY liquidacion;";
				$tabla = mysql_query($consulta);
