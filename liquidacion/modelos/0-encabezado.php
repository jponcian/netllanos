...
//---------------
$pdf->SetXY(0,12);
$pdf->MultiCell(216,4,'PLANILLA DE LIQUIDACIÓN',$linea_muestra,'C');
//---------------
...
//---------------
$pdf->SetXY(0,20);
$pdf->MultiCell(216,4,utf8_decode(buscar_region()),$linea_muestra,'C');
...
$pdf->Cell(35,3,'FECHA VENCIMIENTO',$linea_fija,0,'C',1);
...
list($anno,$mes,$dia)=explode('-',$registro->fecha_pago);
$FECHA_PAGO = mktime(0,0,0,$mes,$dia,$anno);
list($anno,$mes,$dia)=explode('-',$registro->fecha_vencimiento);
