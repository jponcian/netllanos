...
switch ($_SESSION['ORIGEN'])
    ...
    case 16:
		...
		$tabla = mysql_query($consulta);
		// -------------- ACTUALIZACION DEL EXPEDIENTE
		$consulta="UPDATE expedientes_ajustes_ut SET status=6, fecha_devolucion = date(now()), usuario_devolucion = ".$_SESSION['CEDULA_USUARIO']." WHERE anno_expediente=".$_SESSION['ANNO_PRO']." AND num_expediente=".$_SESSION['NUM_PRO']." AND sector=".$_SESSION['SEDE'].";";
		$tabla = mysql_query($consulta);
		// --------------
        break;
	}
