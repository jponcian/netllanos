...
<body style="background: transparent !important;">
			...
			<div class="card mb-2">
				...
				<div class="card-body py-2">
					<div class="row align-items-center">
						...
						<div class="col-md-4 my-1">
							<label for="ODIVISION" class="form-label small"><strong>División Actual:</strong></label>
						...
						<div class="col-md-4 my-1">
							<label for="ODIVISION2" class="form-label small"><strong>División Destino:</strong></label>
	...
	<script language="JavaScript">
		...
		function cargar_tabla() {
			...
			var div2 = $('#ODIVISION2').val();
			if (sede > 0 && div1 > 0 && div2 > 0) {
				$('#div1').load('6a_tabla_aceptar.php?sede1=' + sede + '&div1=' + div1 + '&div2=' + div2);
			} else {
				$('#div1').html('');
			}
		}
		...
		function cargar_combo(tipo, val) {
			$('#div1').html('');
			$('#ODIVISION2').html('<option value="0">Seleccione</option>');
			Swal.fire({
				position: 'bottom-end',
				icon: 'info',
		...
		function cargar_combo2(tipo, val) {
			...
			$.ajax({
				type: "POST",
				url: '6_combo.php?sede=' + $('#OSEDE').val() + '&division=' + val,
				data: 'tipo=' + tipo,
				success: function (resp) { $('#ODIVISION2').html(resp); }
			});
		}
	</script>
</body>
