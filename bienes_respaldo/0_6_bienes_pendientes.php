...
-->
    ...
    <tbody>
      ...
      //-------- 
      $consulta = "SELECT *, lower(descripcion_bien) as descripcion_bien2 FROM vista_bienes_reasignaciones_pendientes WHERE $filtro AND borrado=0 AND por_reasignar=$status GROUP BY numero_bien ORDER BY id_area_actual, descripcion_bien, numero_bien";
      //    echo $consulta;
  ...
  <?php if ($division > 0 and $i > 0) { ?>
    <p align="center">
      <input type="submit" class="boton" name="CMDAPROBAR" value="Aprobar Movimiento" />
      <input type="submit" class="boton" name="CMDDEVOLVER" value="Devolver Movimiento" />
    </p>
  <?php } ?>
  <p align="center">&nbsp;</p>
