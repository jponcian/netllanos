...
$div2 = intval($_GET['div2']);

$filtro = "por_reasignar = 2 AND id_sector_actual = $sede1 AND id_division_actual = $div1 AND id_division_destino = $div2";
$consulta = "SELECT *, lower(descripcion_bien) as descripcion_bien2 FROM vbienes_pendientes WHERE $filtro AND borrado=0 ORDER BY id_area_destino, descripcion_bien, numero_bien";
...
<script>
    function marcar(checkbox, idFila) {
        $('#fila' + idFila).toggleClass('table-info fw-bold', checkbox.checked);
    }
