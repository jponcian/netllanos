...
function Header()
	...
	$registro = mysql_fetch_object($tabla);
		...
		//$this->Cell(0,$alto_cabecera,('Fecha: 11/03/2024'),0,0,'C');
		...
		////----------- VIENEN
		//if ($this->PageNo()>1 and $_SESSION['funcionario']<>'ULTIMA' and $_SESSION['i']>0) //
		//	{
		//	$this->SetFont('Arial','B',$fuente_cabecera);
...
$pdf->Cell($g,$alto,formato_moneda($_SESSION['monto']),1,0,'R');	
