...
<div class="tabla-wrapper" style="max-width: 1100px; margin: 0 auto;">
    ...
    <table id="tablaBienes" class="datatabla formateada display" border="1" style="width:100%">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            if ($result) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<td align="left">' . htmlspecialchars($row['descripcion_bien']) . '</td>';
                    echo '<td align="center">' . htmlspecialchars($row['conservacion']) . '</td>';
                    echo '<td align="right">' . htmlspecialchars($row['valor']) . '</td>';
                    echo '<td align="left">' . htmlspecialchars(($row['area_desc'])) . '</td>';
