...
<body style="background: transparent !important;">
				...
				<td colspan="3"><span class="Estilo1">
						<select name="OSEDE" size="1" onChange="this.form.submit()">
							...
							if ($_SESSION['ADMINISTRADOR'] > 0 or $_SESSION['SEDE_USUARIO'] == 1) {
								$consulta_x = 'SELECT sector as id_sector, nombre FROM vista_sumario_transferidas_liquidacion GROUP BY sector;';
	...
	if ($_POST['CMDCARGAR'] == 'Cargar') {
		...
		//-----------------
		$consulta = "SELECT vista_sumario_transferidas_liquidacion.rif FROM vista_sumario_transferidas_liquidacion WHERE vista_sumario_transferidas_liquidacion.fecha_transferencia_a_liq BETWEEN '" . voltea_fecha($_SESSION['INICIO']) . "' AND '" . voltea_fecha($_SESSION['FIN']) . "' AND vista_sumario_transferidas_liquidacion.sector = " . $_POST['OSEDE'] . "";
