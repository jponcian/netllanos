...
<head>
	...
	<title>Incluir Pagos a Expediente</title>
			...
			<tbody>
				<tr>
					<td height="45" align="center" bgcolor="#FF0000">
						<p class="Estilo7"><u>Incluir Pagos a Expediente </u></p>
					</td>
			...
			<tbody>
				...
				if ($_POST['OSEDE'] > 0) {
					...
					while ($registro = mysql_fetch_object($tabla)) {
						...
						echo '</div></td><td ><div align="center" class="Estilo5"><div align="center"><a href="4.2incluir_pago.php?rif=' . $registro->rif;
						echo '&num=';
