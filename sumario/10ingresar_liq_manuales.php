					...
					if ($_POST['OINICIO'] <> "" and $_POST['OFIN'] <> "") {
						if ($_POST['OMONTO'] > 0) {
							...
							if ($registro_x = mysql_fetch_array($tabla_x)) {
								...
								$consulta_y = "SELECT id_sancion FROM a_sancion WHERE id_sancion>3600 AND id_sancion<3647 AND serie =" . $_POST['OSERIE'] . ";";
	...
	<form name="form1" method="post" action="#vista">
			...
			<tr>
				...
				<td width="77%"><label>
						<select name="OTRIBUTO" onChange="this.form.submit()">
							<option value="-1">Seleccione</option>
							<?php
							$consulta2 = "SELECT id_tributo, nombre FROM a_tributos WHERE id_tributo IN (1,3,7,8,9,11,12,13,20,21,23,24,99) AND tipo=" . $_POST['OTIPO'] . " ORDER BY id_tributo;";
		...
		<table width="55%" border="1" align="center">
			<tr>
				...
				<td width="77%"><label>
						<div align="left"><input onclick='javascript:scwShow(this,event);' type="text" name="OINICIO" size="8" readonly="readonly" value="<?php echo $_POST['OINICIO']; ?>" />
						</div>
					</label></td>
			</tr>
			<tr>
			...
			<?php if ($_POST['OSERIE'] == 38) { ?>
				<tr>
					...
					<td><label>
							<div align="left">
								<input onclick='javascript:scwShow(this,event);' type="text" name="OVENCIMIENTO" size="8" readonly="readonly" value="<?php echo $_POST['OVENCIMIENTO']; ?>" />
							</div>
						</label></td>
				</tr>
				<tr>
					...
					<td><label><input onclick='javascript:scwShow(this,event);' type="text" name="OPAGO" size="8" readonly="readonly" value="<?php echo $_POST['OPAGO']; ?>" /></label></td>
				</tr>
				<tr>
					<td width="23%" bgcolor="#FFFF00">
