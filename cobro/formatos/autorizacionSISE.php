...
$consulta_datos = "SELECT * FROM vista_exp_especiales_siscontri WHERE anno=0" . $_SESSION['ANNO_PRO'] . " AND numero=0" . $_SESSION['NUM_PRO'] . " AND sector =0" . $_SESSION['SEDE'] . ";";
...
$pdf->Ln(8);
$pdf->Cell(0, 5, utf8_decode('N°    ' . $registro_datos->Siglas_resol_aut_spe . '/' . $anno_res . '/' . ($_SESSION['NUM_PRO'])));
//$pdf->Ln(10);
