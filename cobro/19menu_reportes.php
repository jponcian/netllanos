...
<body style="background: transparent !important;">
	...
	<form name="form1" method="post">
		...
		<table border="1" align="center">
			<tr>
				<td align="center" bgcolor="#FF0000" colspan="9"><span class="Estilo1 Estilo22 Estilo55"><span class="TituloTabla">Planillas</span></span></td>
			</tr>
			<tr>
		...
		<table width="30%" border="1" align="center">
			<tr>
				<td height="33" colspan="2" align="center" bgcolor="#FF0000">
					<p class="Estilo1"><span class="TituloTabla">Dependencia</span></p>
				</td>
				<td colspan="4" align="center" bgcolor="#FF0000">
					<p class="Estilo1"><span class="TituloTabla">Fecha
							<?php
							if ($_POST['OOPCION'] == "1") {
								echo 'de Recepci�n en Cobro';
							}
							if ($_POST['OOPCION'] == "2") {
								echo 'de Asignaci�n';
							}
	...
	<table width=300 align=center border=0>
		<td colSpan=1>
			<div align="center">
				<form name="form3" method="post" action="reportes/contabilidad_fiscal.php" target="_blank">
