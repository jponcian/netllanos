...
<body style="background: transparent !important;">
  <p>
    ...
    $consulta_00 = "SELECT * FROM vista_exp_cobro WHERE anno=" . $_SESSION['ANNO_PRO'] . " AND numero=" . $_SESSION['NUM_PRO'] . " AND sector =" . $_SESSION['SEDE'] . ";";
    ...
    if ($_POST['CMDGUARDAR'] == 'Guardar') {
      ...
      if ($ut_aplicadas > 0) {
        ...
        include "../funciones/0_guardar_sancion_cob.php";
        //-----------
      }
    }
    ?>
  ...
  <form name="form1" method="post" action="#vista">
    ...
    <table width="60%" border="1" align="center">
      <tr>
        ...
        <td><label>
            <div align="center"><span class="Estilo15"><?php echo formato_rif($registro_00->rif); ?></span></div>
          </label></td>
      ...
      <tr>
        ...
        <td><label>
            <div align="center"><span class="Estilo15"><?php echo formato_cedula($registro_00->coordinador); ?></span></div>
          </label></td>
      ...
      <tr>
        <td bgcolor="#CCCCCC"><strong>Cedula:</strong></td>
        <td><label>
            <div align="center"><span class="Estilo15"><?php echo formato_cedula($registro_00->funcionario); ?></span></div>
          </label></td>
