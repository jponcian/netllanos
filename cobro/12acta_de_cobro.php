...
<body style="background: transparent !important;">
	...
	<form name="form1" method="post">
		<table width="55%" border=1 align=center class="formateada">
			<tbody>
				<tr>
			...
			<tbody>
				...
				if ($_POST['OSEDE'] > 0) {
					...
					while ($registro = mysql_fetch_object($tabla)) {
						...
						echo $i;
						echo '</div></td><td ><div align="center" class="Estilo5"><div align="center"><a href="12-1generar_acta.php?rif=' . $registro->rif;
						echo '&num=';
