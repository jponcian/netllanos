...
include "../../funciones/auxiliar_php.php";
	...
	$Titulos = array('','RELACIÓN DE PLANILLAS RECIBIDAS EN COBRO','RELACIÓN DE PLANILLAS ASIGNADAS','RELACIÓN DE PLANILLAS PAGADAS','','');
	...
	$consulta_x = "SELECT nombre FROM z_sectores WHERE id_sector=".$_SESSION['SEDE_USUARIO'];
	$tabla_x = mysql_query($consulta_x);
	$regstro_x = mysql_fetch_object($tabla_x);
...
<table bgcolor="#CCCCCC" width="100%" border="1">
    ...
    <td rowspan="2" ><div align="center" class="Estilo7">Numero Liquidaci&oacute;n</div></td>
    <td rowspan="2" ><div align="center" class="Estilo7">Fecha de Liquidaci&oacute;n</div></td>
	<td rowspan="2" ><div align="center" class="Estilo7">Fecha de Notificaci&oacute;n</div></td>
	<td rowspan="2" ><div align="center" class="Estilo7">Fecha de Vencimiento</div></td>
	<td rowspan="2" ><div align="center" class="Estilo7">Fecha de Pago</div></td>
 ...
 <?php
	...
	switch ($_SESSION['VARIABLE'])
		...
		case 2:
			...
			$Orden = ' ORDER BY fecha_impresion ASC';
		break;
		////////////////////////
		case 3:
			$Filtro = " WHERE sector = ".$_SESSION['OSEDE']." AND fecha_pag>='".$_SESSION['FECHA1']."' and fecha_pag<='".$_SESSION['FECHA2']."'";
			$Orden = ' ORDER BY fecha_transferencia_not ASC';
		break;	
		////////////////////////
//		case 4:
...
//			$Orden = ' ORDER BY fecha_importacion_a_not ASC';
//		break;	
//		////////////////////////
//		case 5:
...
//			$Orden = ' ORDER BY fecha_tranferencia_a_cob ASC';
//		break;				
	...
	$Sentencia = "SELECT fecha_pag, fecha_not, cont_esp, sector, origen_liquidacion, anno_expediente, num_expediente , rif, contribuyente, periodoinicio, periodofinal, planilla_notificacion, numeroliquidacion, siglas, fecha_liquidacion, liquidacion, serie, monto_bs, concurrencia, especial, id_tributo FROM vista_liquidacion_planillas";
	...
	$txt= voltea_fecha($registro_x->fecha_pag);
	echo '<td><div align="center" class="Estilo5">';
	echo $txt;
	echo '</div></td>';	
