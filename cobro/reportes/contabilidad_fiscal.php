...
if ($_SESSION['VERIFICADO'] != "SI") { 
	...
	if ($_SESSION['ORIGEN_USUARIO']>0 and $_SESSION['ORIGEN_USUARIO']<>13) {$origen=' and origen_liquidacion='.$_SESSION['ORIGEN_USUARIO'];} else {$origen=' ';}
	// -------------------------------------
...
<table width="100%" border="1">
 ...
 <?php
	...
	if ($registro_x->serie <> 38 and $registro_x->id_tributo <> 52) {	$txt= 3; }
	else {	$txt= 1; }
	echo '<td><div align="center" class="Estilo5">';
	echo $txt;
	echo '</div></td>';
