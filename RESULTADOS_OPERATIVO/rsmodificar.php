...
<head>
    ...
    <title>Modificar Resultados Operativos</title>
    ...
    <script type="text/javascript" src="funcionesmod.js"></script>
    ...
    <script type="text/javascript">
        function validaMultasDF() {
            ...
            if (Multado == 1) {
                ...
                document.form1.NotificacionCierre.disabled = true;
...
<body style="background: transparent !important;">
    <form id="form1" name="form1" method="post" action="">
        ...
        <div id="encabezado" class="CSSTableGenerator">
            <table>
                <tr>
                    <td bgcolor="#333333" colspan="2" style="font-size: 14px; color: #FFF; text-align: center;">Modificar Resultado Operativo - Providencia Administrativa</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input name="FechaOperativo" id="FechaOperativo" readonly="readonly" type="text" size="10" maxlength="10" value="" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input name="CadenaTienda" id="CadenaTienda" type="text" size="80" maxlength="250" value="" onfocus="mostrariva()" /></td>
                </tr>
                <tr>
        ...
        <div id="iva" class="CSSTableGenerator">
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td width="65%">
                        <p><select name="TipoMF" id="TipoMF" language="javascript" onChange="validaNoAplica()">
                ...
                <tr>
                    ...
                    <td><input name="ModeloMF" id="ModeloMF" type="text" size="60" maxlength="50" <?php if ($_POST[TipoMF] == "NO APLICA") {
                ...
                <tr>
                    ...
                    <td>
                        <p><select name="CumpleMF" id="CumpleMF" language="javascript" onChange="validaCumpleMF()">
                                <option>SI</option>
                                <option>NO</option>
                            </select></p>
                    </td>
                ...
                <tr>
                    ...
                    <td><input name="SancionesMF" id="SancionesMF" type="text" size="80" maxlength="250" <?php if ($_POST[TipoMF] == "NO APLICA" or $_POST[CumpleMF] == "NO") {
                                                                                                                echo 'disabled="disabled"';
                                                                                                            } ?> value="" /> </td>
                </tr>
            </table>
        </div>
        <div id="flotante" class="CSSTableGenerator">
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <p><select name="MultasDF" id="MultasDF" language="javascript" onchange="validaMultasDF()">
                                <option>SI</option>
                                <option>NO</option>
                            </select></p>
                    </td>
                ...
                <tr>
                    <td>Clausura: </td>
                    <td>
                        <p><select name="Clausura" id="Clausura" language="javascript" onChange="validaClausura()">
                                <option>SI</option>
                                <option>NO</option>
                            </select></p>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <p><select name="DiasClausura" id="DiasClausura" language="javascript">
                ...
                <tr>
                    ...
                    <td><input name="NotificacionCierre" id="NotificacionCierre" readonly="readonly" type="text" size="10" maxlength="10" value="" />
                    </td>
                </tr>
                <tr>
                    <td width="35%">Monto Multas (<span class="resaltar">Cantidad en EUROS</span>): </td>
                    <td width="65%"><input name="MontoSanciones" id="MontoSanciones" style="text-align:right" type="text" size="10" maxlength="10" value="" /> (Utilice PUNTO "." no COMA "," para separar solamente decimales Ejemplo: 1234.50)</td>
                </tr>
                <tr>
                    <td>Incumplimientos Deberes Formales: </td>
                    <td><input name="Sanciones" id="Sanciones" type="text" size="80" maxlength="250" value="" /></td>
                </tr>
                <tr>
                    <td style="color:red">Observaciones: (Incluir descripcion actividad económica)</td>
                    <td><input name="Observaciones" id="Observaciones" type="text" size="80" maxlength="250" value="" /></td>
                </tr>
            </table><br />
