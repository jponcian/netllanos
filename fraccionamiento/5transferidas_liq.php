...
<body style="background: transparent !important;">
	...
	if ($_POST['CMDCARGAR'] == 'Cargar') {
		$consulta = "SELECT liquidacion.rif FROM liquidacion WHERE fecha_transferencia_a_liq BETWEEN '" . $_SESSION['INICIO'] . "' AND '" . $_SESSION['FIN'] . "' AND liquidacion.sector = " . $_SESSION['SEDE'] . " AND origen_liquidacion=" . $origenF . "";
