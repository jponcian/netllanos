...
// ORIGEN DEL FRACCIONAMIENTO
switch ($origenF) 
	{
	case 8:
		$consulta_x = "SELECT * FROM vista_jefe_esp WHERE id_sector=".$_SESSION['SEDE_USUARIO'].";";
		break;
	case 17:
		$consulta_x = "SELECT * FROM vista_jefe_rec WHERE id_sector=".$_SESSION['SEDE_USUARIO'].";";
		break;		
	}
