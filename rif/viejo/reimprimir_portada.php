...
if ($_POST['CMDGUARDAR'] == "Guardar") {
	$guardar = 0;
	if ($_POST['ORIF'] <> "" and $_POST['OCOORDINADOR'] <> "" and $_POST['OFUNCIONARIO'] <> "") {
...
<body style="background: transparent !important;">
	...
	<div align="center">
		...
		if ($_SESSION['VARIABLE'] == 'REGISTRADA') {
			...
			// FIN
			echo '<form name="form3" method="post" action="formatos/hoja_sanciones.php?num=' . $_POST['OPORTADANUM'] . '&anno=' . $_POST['OPORTADANNO'] . '&sede=0' . $_POST['OSEDE'] . '" target="_blank">';
