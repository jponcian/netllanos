...
<body style="background: transparent !important;">
	...
	<form name="form1" method="post" action="" enctype="multipart/form-data">
		...
		?>
			...
			$fecha_recaudacion = $_POST['OFECHA'];
		...
		function guardar_planilla($rif, $periodo, $forma, $agencia, $fecha_recaudacion, $monto, $documento)
		{
			...
			$sql_add = mysql_query("INSERT INTO ce_pagos (Rif,Tipo_Impuesto,Numero,Periodo,Quincena,Fecha_Ven,Fecha_Presentacion,Fecha_Pago,Agencia,Monto,Sector,txt) VALUES ('" . $rif . "'," . $forma . "," . $documento . ",'" . $periodo . "'," . $quincena . ",'" . $fecha_vencimiento . "','" . $fecha_recaudacion . "','" . $fecha_recaudacion . "'," . $id_agencia . "," . $monto . "," . $sector . ",1)");
		}
			?>
