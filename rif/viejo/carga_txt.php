...
function guardar_planilla($rif, $periodo, $forma, $agencia, $fecha_recaudacion, $banco, $monto, $documento)
{
	...
	$sql_add = mysql_query("INSERT INTO ce_pagos (Rif,Tipo_Impuesto,Numero,Periodo,Quincena,Fecha_Ven,Fecha_Presentacion,Fecha_Pago,Agencia,Monto,Sector,txt) VALUES ('" . $rif . "'," . $reg_forma->Numero . "," . $documento . ",'" . $periodo . "'," . $quincena . ",'" . $fecha_vencimiento . "','" . $fecha_recaudacion . "','" . $fecha_recaudacion . "'," . $id_agencia . "," . $monto . "," . $sector . ",1)");
}
