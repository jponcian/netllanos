...
$fecha = date("d", strtotime($registro->FechaRegistro)) . " de " . ($_SESSION['meses_anno'][(date("m", strtotime($registro->FechaRegistro)))]) . " de " . date("Y", strtotime($registro->FechaRegistro));;
// IMAGEN
