...
<body style="background: transparent !important;">
	...
	if ($_POST['CMDCARGAR'] == 'Cargar') {
		...
		$consulta = "SELECT vista_transferidas_rif_liquidacion.rif FROM vista_transferidas_rif_liquidacion WHERE vista_transferidas_rif_liquidacion.fecha_transferencia_a_liq BETWEEN '" . $_SESSION['INICIO'] . "' AND '" . $_SESSION['FIN'] . "' AND vista_transferidas_rif_liquidacion.sector = " . $_POST['OSEDE'] . "";
		$tabla = mysql_query($consulta);
		$numero_filas = mysql_num_rows($tabla);

		if ($numero_filas > 0) {
			echo '<form name="form4" method="post" action="formatos/transferidas_a_liquidacion.php" target="_blank">
