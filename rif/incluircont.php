...
if ($_POST['CMDGUARDAR'] == "Guardar") {
	...
	if ($_POST[OESTADO] > 0 and $_POST[OCIUDAD] > 0 and $_POST[OURBANIZACION] > 0 and $_POST[ODOMICILIO] <> "" and $_POST[OCONTRIBUYENTE] <> "" and $_POST[OACTIVIDAD] > 0) {
		...
		$tabla = mysql_query($consulta);
		//-----------------
		$consulta = "INSERT INTO contribuyentes (rif,contribuyente,id_estado,id_ciudad,id_zona,DescripcionDomicilio,actividad,CedulaTranscriptor,FechaActualizacion) VALUES ('" . strtoupper($_SESSION['RIF']) . "','" . strtoupper($_POST[OCONTRIBUYENTE]) . "'," . $_POST[OESTADO] . "," . $_POST[OCIUDAD] . "," . $_POST[OURBANIZACION] . ",'" . strtoupper($_POST[ODOMICILIO]) . "'," . $_POST[OACTIVIDAD] . ",'" . $_SESSION['CEDULA_USUARIO'] . "','" . date("Y/m/d") . "')";
		$tabla = mysql_query($consulta);
		// MENSAJE DE GUARDADO
...
<head>
	<title>Incluir Contribuyente</title>
...
<body style="background: transparent !important;">
	...
	<form name="form1" method="post" action="">
		<table width="700" border="1" align="center">
			<tr>
				<td height="27" colspan="9" align="center" bgcolor="#FF0000"><span class="Estilo7"><u>Contribuyente</u></span></td>
			</tr>
			<tr>
