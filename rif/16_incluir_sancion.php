...
<body style="background: transparent !important;">
  <p>
    ...
    <?php
    //--------- BUSCAMOS LOS DATOS
    $consulta_00 = "SELECT * FROM vista_exp_rif WHERE anno=" . $_SESSION['ANNO_PRO'] . " AND numero=" . $_SESSION['NUM_PRO'] . " AND sector =" . $_SESSION['SEDE'] . ";";
  ...
  <form name="form1" method="post" action="#vista">
    ...
    <a name="vista"></a>
    <?php $rif = 'no';
    include "../funciones/0_cuadro_multas1.php"; ?>
