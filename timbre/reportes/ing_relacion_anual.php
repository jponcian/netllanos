...
class PDF extends FPDF
{
	...
	//---------------
	$this->SetFont('Times','B',10);
	$this->MultiCell(0,6,'Año: '. $_SESSION['var1'] ,$linea_muestra,'L');
	$this->ln(2);
	//---------------
