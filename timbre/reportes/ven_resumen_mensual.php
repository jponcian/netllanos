...
while ($registro = mysql_fetch_object($tabla))
	...
	$pdf->Cell($d,6,number_format(doubleval($registro->precio*100000),2,',','.'),$linea_muestra,0,'C',$color);
	$pdf->Cell($e,6,number_format(doubleval(minimo_soberano(($registro->cantidad*$registro->precio),$registro->precio)),2,',','.'),$linea_muestra,0,'C',$color);
	//------------------------------------------------------------------------------------------
	$pdf->ln(6.5); $i ++;
	//-------------------------------------------------------------------------------------------
	}
