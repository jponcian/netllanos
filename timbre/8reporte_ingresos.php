...
<body style="background: transparent !important;">
	...
	<form name="form1" method="post">
		...
		<table width="24%" border="1" align="center">
			<tr>
				<td align="center" height="30" bgcolor="#FF0000" colspan="9"><span class="Estilo7 Estilo1">INGRESOS</span></td>
			</tr>
			<tr>
	...
	<form name="form2" method="post" action="<?php
												if ($_POST['OOPCION1'] == '1') {
													echo 'reportes/ing_relacion_anual.php';
