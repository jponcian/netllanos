...
$pdf->Cell(45,6,'BsS. '.(number_format(doubleval(minimo_soberano($monto,0)),2,',','.')),$linea_muestra,0,'R');
$pdf->Cell(45,6,'BsS. '.number_format(doubleval($comision),2,',','.'),$linea_muestra,0,'R');
$pdf->Cell(0,6,'BsS. '.(number_format(doubleval(minimo_soberano($total,0)),2,',','.')),$linea_muestra,0,'R');
//---------------
