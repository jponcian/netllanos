					...
					<td bgcolor="#FFFFFF">
						<div align="center"><strong>
							...
							<select name="OPERIODO" size="1" onChange="this.form.submit()">
								...
								//----------
								$consulta_x = "SELECT fecha FROM timbre_inv_detallado_mensual WHERE right(fecha,2)=right(year(date(now())),2) OR right(fecha,2)=18 GROUP BY fecha ORDER BY fechaproceso DESC;";
