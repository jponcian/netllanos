...
//---------- FILTRO POR AREA
if ($_SESSION['AREA']=='0' or $_SESSION['DIVISIONES']=='0' ) //$_SESSION['AREAS'] == 'TODAS' and 
	{
	$filtro1 = "id_area";
	$orden1 = "area,";
	}
...
while ($registro_x = mysql_fetch_object($tabla_x))
	...
	if ($y1 > 170 or $y2 > 170 or $siguiente_area == 1) 
		...
		$pdf->Cell(25,$alto,'',1,0,'L');
		$pdf->Cell(115,$alto,'VAN',1,0,'C');
		$pdf->Cell(20,$alto,'SUBTOTAL',1,0,'C');
        //$pdf->Cell(23,$alto,'SUBTOTAL',1,0,'C');	original	
	...
	$pdf->Cell($f,($alto2), formato_moneda_bienes($registro_x->valor),$linea,0,'R'); 
	//--------------------
...
$pdf->Cell(25,$alto,'',1,0,'L');
$pdf->Cell(25,$alto,'',1,0,'L');
$pdf->Cell(124,$alto,'',1,0,'C');
$pdf->Cell(15,$alto,'TOTAL',1,0,'C');	
$pdf->Cell(0,$alto,formato_moneda_bienes($_SESSION['monto']),1,0,'R');	
//----------------------------------
