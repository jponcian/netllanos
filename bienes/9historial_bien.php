...
<td ><label><span class="">
<input type="text" name="ODESCRIPCION" size="70"  value="<?php //echo $_POST['ODESCRIPCION']; 
                                                          ?>"></span></label></td>
</tr>
</table>
<p align="center">
    ...
    <div role="document" style="width: 80%; margin: 0 auto;">
      ...
      <table class="datatabla formateada" width="100%" border=1 align=center style="background-color: whitesmoke">
        <thead>
          <!--
  <tr>
	<td bgcolor="#FF0000" height="40" colspan="7" align="center"><p class="Estilo7"><u>Resultados de la Busqueda </u></p></td>
  </tr>
-->
          <tr>
            <th>
        ...
        <tbody>
          ...
          //if ($_POST['OBIEN']>0)
          //	{
          $consulta = "SELECT *, lower(descripcion_bien) as descripcion_bien2 FROM vista_bienes_nacionales WHERE borrado=0 AND numero_bien <> '' ORDER BY sector, division, area, numero_bien";
          $consulta = "SELECT *, lower(descripcion_bien) as descripcion_bien2 FROM vista_bienes_nacionales WHERE borrado=0 AND numero_bien <> '' ORDER BY numero_bien";
