...
<head>
  ...
  <link rel="preload" href="../../lib/AdminLTE/dist/css/adminlte.css" as="style" />
        ...
        <ul class="navbar-nav ms-auto">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
              <a href="#" class="dropdown-item">
                ...
                <div class="d-flex">
                  <div class="flex-shrink-0">
                    <img
                      src="../../lib/AdminLTE/dist/assets/img/user1-128x128.jpg"
                      alt="User Avatar"
              ...
              <a href="#" class="dropdown-item">
                ...
                <div class="d-flex">
                  <div class="flex-shrink-0">
                    <img
                      src="../../lib/AdminLTE/dist/assets/img/user8-128x128.jpg"
                      alt="User Avatar"
                      class="img-size-50 rounded-circle me-3" />
                  </div>
                  <div class="flex-grow-1">
              ...
              <a href="#" class="dropdown-item">
                ...
                <div class="d-flex">
                  <div class="flex-shrink-0">
                    <img
                      src="../../lib/AdminLTE/dist/assets/img/user3-128x128.jpg"
                      alt="User Avatar"
                      class="img-size-50 rounded-circle me-3" />
                  </div>
                  <div class="flex-grow-1">
          ...
          <li class="nav-item dropdown user-menu">
            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
              <img
                src="../../lib/AdminLTE/dist/assets/img/user2-160x160.jpg"
    ...
    <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
      ...
      <div class="sidebar-brand">
        ...
        <a href="./index.html" class="brand-link">
          <!--begin::Brand Image-->
          <img
            src="../../lib/AdminLTE/dist/assets/img/AdminLTELogo.png"
            alt="AdminLTE Logo"
          ...
          <ul
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item"><a href="4_gestion_datos_funcionario.php" class="nav-link"><i class="nav-icon bi bi-circle"></i>
                    <p>Gestión</p>
                  </a></li>
                <li class="nav-item"><a href="5_nuevos.php" class="nav-link"><i class="nav-icon bi bi-circle"></i>
                    <p>Nuevo Ingreso</p>
                  </a></li>
              </ul>
            </li>
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item"><a href="1_gestion_roles.php" class="nav-link"><i class="nav-icon bi bi-circle"></i>
                    <p>Roles</p>
                  </a></li>
                <li class="nav-item"><a href="2_gestion_accesos.php" class="nav-link"><i class="nav-icon bi bi-circle"></i>
                    <p>Accesos</p>
                  </a></li>
                <li class="nav-item"><a href="7_gestion_origenes.php" class="nav-link"><i class="nav-icon bi bi-circle"></i>
                    <p>Orígenes</p>
                  </a></li>
              </ul>
            </li>
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item"><a href="6_importar_planillas.php" class="nav-link"><i class="nav-icon bi bi-circle"></i>
                    <p>Importar Planillas</p>
                  </a></li>
              </ul>
            </li>
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item"><a href="3_gestion_accesos_completos.php" class="nav-link"><i class="nav-icon bi bi-circle"></i>
                    <p>Perfil por Funcionario</p>
                  </a></li>
                <li class="nav-item"><a href="10_soporte_tecnico.php" class="nav-link"><i class="nav-icon bi bi-circle"></i>
                    <p>Bienes en Reparación</p>
                  </a></li>
                <li class="nav-item"><a href="9_historial_bien.php" class="nav-link"><i class="nav-icon bi bi-circle"></i>
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item"><a href="8_menu_reportes.php" class="nav-link"><i class="nav-icon bi bi-circle"></i>
                    <p>Inventario Bienes</p>
                  </a></li>
              </ul>
            </li>
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item"><a href="../fiscalizacion/19_providencia_reversar.php" class="nav-link"><i class="nav-icon bi bi-circle"></i>
                    <p>Expedientes</p>
                  </a></li>
              </ul>
            </li>
                        ...
                        <ul class="contacts-list">
                          ...
                          <li>
                            <a href="#">
                              <img
                                class="contacts-list-img"
                                src="../../lib/AdminLTE/dist/assets/img/user7-128x128.jpg"
                                alt="User Avatar" />
                              <div class="contacts-list-info">
                                <span class="contacts-list-name">
                                  Sarah Doe
                          ...
                          <li>
                            <a href="#">
                              <img
                                class="contacts-list-img"
                                src="../../lib/AdminLTE/dist/assets/img/user5-128x128.jpg"
                                alt="User Avatar" />
                              <div class="contacts-list-info">
                                <span class="contacts-list-name">
                                  Nora S. Vans
                          ...
                          <li>
                            <a href="#">
                              <img
                                class="contacts-list-img"
                                src="../../lib/AdminLTE/dist/assets/img/user6-128x128.jpg"
                                alt="User Avatar" />
                              <div class="contacts-list-info">
                                <span class="contacts-list-name">
                                  John K.
                    ...
                    <div class="card-body p-0">
                      <div class="row text-center m-1">
                        ...
                        <div class="col-3 p-2">
                          <img
                            class="img-fluid rounded-circle"
                            src="../../lib/AdminLTE/dist/assets/img/user4-128x128.jpg"
                            alt="User Image" />
                          <a
                            class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0"
                            href="#">
                ...
                <div class="card-body p-0">
                  <div class="px-2">
                    <div class="d-flex border-top py-2 px-1">
                      <div class="col-2">
                        <img
                          src="../../lib/AdminLTE/dist/assets/img/default-150x150.png"
                          alt="Product Image"
                          class="img-size-50" />
                      </div>
                      <div class="col-10">
