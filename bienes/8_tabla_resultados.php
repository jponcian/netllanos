    ...
    while ($registro = mysqli_fetch_object($tabla)) {
        ...
        <tr>
            ...
            <td class="text-center">
                <a href="formatos/x_memorando_reasignacion.php?id=<?php echo $registro->id_reasignacion; ?>" target="_blank"
                    class="btn btn-sm btn-secondary" title="Memorando"><i class="fas fa-file-alt"></i></a>
                <a href="reportes/x_reasignacion.php?comprobante=31&id=<?php echo $registro->id_reasignacion; ?>"
                    target="_blank" class="btn btn-sm btn-danger" title="Entrega"><i class="fa-solid fa-upload"></i></a>
                <a href="reportes/x_reasignacion.php?comprobante=21&id=<?php echo $registro->id_reasignacion; ?>"
                    target="_blank" class="btn btn-sm btn-success" title="Recepción"><i class="fa-solid fa-download"></i></a>
            </td>
        </tr>
        <?php
    } // fin while
...
if ($i === 0) {
    $num_cols = 9;
    if (isset($eliminar) && ($eliminar == 'SI' or $reasignar == 'SI')) {
        $num_cols = 10;
    }
