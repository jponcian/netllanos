  ...
  <tbody>
    <tr>
      <td bgcolor="#FF0000" height="40" colspan="10" align="center">
        <p class="Estilo7"><u>Listado de Movimientos Internos pendientes de Confirmar</u></p>
      </td>
    </tr>
    <tr>
...
<?php if ($division > 0 and $i > 0) { ?>
  <p align="center">
    <input type="submit" class="boton" name="CMDAPROBAR" id="CMDAPROBAR" value="Enviar Movimiento" />
  </p>
<?php } ?>